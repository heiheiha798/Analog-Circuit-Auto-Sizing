...
def extract_performance_data(filename="results_1.0.1_1.txt"):
    # ... (no changes needed)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Plot performance trends from results file with optional iter range.")
    parser.add_argument('-f', '--file', default='results_1.0.1_1.txt', help='Results filename to read (default: results_1.0.1_1.txt)')
    parser.add_argument('-s', '--start-iter', type=int, default=1, help='Start iteration (1-based, inclusive).')
    parser.add_argument('-e', '--end-iter', type=int, default=1000, help='End iteration (1-based, inclusive). If omitted, use end of file.')
    parser.add_argument('-o', '--output-dir', default='performance_plots_v1.0.1_1', help='Output directory prefix for plots.')
    ...
    if results:
        plot_performance_data(results, output_dir=args.output_dir, start_iter=args.start_iter, end_iter=args.end_iter)