...
def extract_performance_data(filename="results_5.1_1.txt"):
    # ... (no changes needed)
...
if __name__ == "__main__":
    results = extract_performance_data("results_5.1_1.txt")
    if results:
        plot_performance_data(results, output_dir="performance_plots_v5.1_1")