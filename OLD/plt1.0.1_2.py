...
def extract_performance_data(filename="results_1.0.1_2.txt"):
    # ... (no changes needed)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-f', '--file', default='results_1.0.1_2.txt', help='Results filename to read (default: results_1.0.1_2.txt)')
    ...
    parser.add_argument('-o', '--output-dir', default='performance_plots_v1.0.1_2', help='Output directory prefix for plots.')
