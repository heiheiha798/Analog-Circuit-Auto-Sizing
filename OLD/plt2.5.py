...
def extract_performance_data(filename="tmp5.1.txt"):
    # ... (no changes needed)
...
if __name__ == "__main__":
    results = extract_performance_data("tmp5.1.txt")
    if results:
        plot_performance_data(results, output_dir="performance_plots_v4")