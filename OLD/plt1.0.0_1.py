...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--start-iter', type=int, default=400, help='Start iteration (1-based, inclusive).')
    parser.add_argument('-e', '--end-iter', type=int, default=None, help='End iteration (1-based, inclusive). If omitted, use end of file.')
    parser.add_argument('-o', '--output-dir', default='performance_plots_v1.0.0_1', help='Output directory prefix for plots.')
