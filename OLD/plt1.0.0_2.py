...
def extract_performance_data(filename="results_1.0.0_2.txt"):
    # ... (no changes needed)
...
if __name__ == "__main__":
    results = extract_performance_data("results_1.0.0_2.txt")
    if results:
        plot_performance_data(results, output_dir="performance_plots_v1.0.0_2")