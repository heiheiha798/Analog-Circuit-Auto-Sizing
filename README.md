...
基于两阶段爬山算法的模拟电路尺寸优化框架，为2025-EDA精英挑战赛赛题六-模拟电路自动尺寸优化设计开发。
...
为2025年EDA精英挑战赛-模拟电路自动尺寸优化开发。三等奖（参与奖）

注：为了提交测试平台，做了接口封装，很多原本可以使用的运行指令被取消了，具体请见main分支开发历史。

2026-06-25 update

注：当时总结因为只有两个 public case 导致没法发现算法可能只对某些初始化条件能有效梯度下降，如果复用代码还请注意。
